	...
	public class AccountManager
	{
		...
		public void SaveAccounts()
		{
			...
			try
			{
				var protectedAccounts = _accounts
					.Select(a => new AltAccount(a.SecurityToken, a.UserId, a.Username, a.DisplayName))
					.ToList();
		...
		public async Task<bool> ValidateAccountAsync(AltAccount account)
		{
			...
			try
			{
				...
				var handler = new HttpClientHandler { CookieContainer = new CookieContainer() };
				handler.CookieContainer.Add(new Cookie(".ROBLOSECURITY", account.SecurityToken, "/", ".roblox.com"));
