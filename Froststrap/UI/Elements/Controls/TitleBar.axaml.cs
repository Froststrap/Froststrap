...
namespace Froststrap.UI.Elements.Controls
{
    public class TitleBar : TemplatedControl
    {
        ...
        protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
        {
            ...
            if (minBtn != null) minBtn.Click += (s, ev) => window.WindowState = Avalonia.Controls.WindowState.Minimized;

            var maxBtn = e.NameScope.Find<Button>("PART_MaximizeButton");
            if (maxBtn != null) maxBtn.Click += (s, ev) =>
            ...
            if (closeBtn != null) closeBtn.Click += (s, ev) => window.Close();
        }
    }
}