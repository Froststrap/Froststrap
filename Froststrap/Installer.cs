...
namespace Froststrap
{
    internal class Installer
    {
        ...
        public async void DoInstall()
        {
            ...
            if (!IsImplicitInstall)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    await Frontend.ShowMessageBox(Strings.Installer_Install_CannotOverwrite, MessageBoxImage.Error);
            ...
            else
            {
                ...
                {
                    _ = App.State.Load(false);
                }
            }
            _ = App.Settings.Load(false);
            _ = App.State.Load(false);
            _ = App.FastFlags.Load(false);
            App.Settings.Save();
        ...
        public async Task <bool> CheckInstallLocation()
        {
            ...
            else
            {
                    ...
                    && Directory.EnumerateFileSystemEntries(InstallLocation).Any())
                {
                    ...
                    MessageBoxResult result = await Frontend.ShowMessageBox(
        ...
        public static async void DoUninstall(bool keepData)
        {
...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        public async void ImportSettingsFromSelectedApp()
        {
            if (ImportSource == ImportSettingsFrom.None)
            {
            ...
            {
                await Frontend.ShowMessageBox(Strings.Installer_InstallationNotFound, MessageBoxImage.Information);
                return;
            }
